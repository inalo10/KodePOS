...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        function printHeaderRow(row, drawRowHooks, drawCellHooks) {
            var table = config_1.Config.tableInstance();
            ...
            for (var i = 0; i < table.columns.length; i++) {
                ...
                var CellsOfNullRow = [];
                for (var ii = row.index + 1; ii < table.headerRows.length; ii++) {
                    var row2 = table.rows[ii];
                    var columnT = table.columns[i];
                    var cellT = row2.cells[columnT.dataKey];

                    if (cellT.text == null || cellT.text == 'null') {
                        config_1.Config.applyStyles(cellT.styles);
                        cellT.x = table.cursor.x;
                        cellT.y = table.cursor.y;
                        cellT.height = row2.height;
                        cellT.width = columnT.width;
                        if (cellT.styles.valign === 'top') {
                            cellT.textPos.y = table.cursor.y + cellT.padding('top');
                        }
                        else if (cellT.styles.valign === 'bottom') {
                            cellT.textPos.y = table.cursor.y + row2.height - cellT.padding('bottom');
                        }
                        else {
                            cellT.textPos.y = table.cursor.y + row2.height / 2;
                        }
                        if (cellT.styles.halign === 'right') {
                            cellT.textPos.x = cellT.x + cellT.width - cellT.padding('right');
                        }
                        else if (cellT.styles.halign === 'center') {
                            cellT.textPos.x = cellT.x + cellT.width / 2;
                        }
                        else {
                            cellT.textPos.x = cellT.x + cellT.padding('left');
                        }

                        CellsOfNullRow.push(cellT);
                    } else {
                        ii = table.headerRows.length;
                    }
                ...
                for (var j = i + 1; j < table.columns.length; j++) {
                    var column2 = table.columns[j];
                    var cell2 = row.cells[column2.dataKey];
                    if (cell2.text == null || cell2.text == 'null') {


                        config_1.Config.applyStyles(cell2.styles);
                        cell2.x = table.cursor.x;
                        cell2.y = table.cursor.y;
                        cell2.height = row.height;
                        cell2.width = column2.width;
                        if (cell2.styles.valign === 'top') {
                            cell2.textPos.y = table.cursor.y + cell2.padding('top');
                        }
                        else if (cell.styles.valign === 'bottom') {
                            cell2.textPos.y = table.cursor.y + row.height - cell2.padding('bottom');
                        }
                        else {
                            cell2.textPos.y = table.cursor.y + row.height / 2;
                        }
                        if (cell2.styles.halign === 'right') {
                            cell2.textPos.x = cell2.x + cell2.width - cell2.padding('right');
                        }
                        else if (cell2.styles.halign === 'center') {
                            cell2.textPos.x = cell2.x + cell2.width / 2;
                        }
                        else {
                            cell2.textPos.x = cell2.x + cell2.padding('left');
                        }
                        indexOfnull.push(j);
                        CellsOfNull.push(cell2);
                        colSpan = true;
                    } else {
                ...
                if (cell.styles.valign === 'top') {
                    ...
                    cell.textPos.y = table.cursor.y + row.height + getHeightSpan(CellsOfNullRow) - cell.padding('bottom');
                }
                else {
                    cell.textPos.y = table.cursor.y + (row.height + getHeightSpan(CellsOfNullRow)) / 2;
                }
                if (cell.styles.halign === 'right') {
                    cell.textPos.x = cell.x + cell.width + getWidthSpan(CellsOfNull) - cell.padding('right');
                }
                else if (cell.styles.halign === 'center') {
                    cell.textPos.x = cell.x + (cell.width + getWidthSpan(CellsOfNull)) / 2;
                }
                else {
                    cell.textPos.x = cell.x + cell.padding('left');
                }
                var shouldDrawCell = cell.text == null || cell.text == 'null' ? false : true;
                ...
                if (shouldDrawCell) {
                    ...
                    if (fillStyle) {
                        table.doc.rect(cell.x, cell.y, cell.width + getWidthSpan(CellsOfNull), cell.height + getHeightSpan(CellsOfNullRow), fillStyle);
                    }
                ...
                table.cursor.x += cell.width + getWidthSpan(CellsOfNull);
                if (colSpan) {
                    i = i + CellsOfNull.length;
                }
            }
            table.cursor.y += row.height;
        }
        exports.printHeaderRow = printHeaderRow;
        ...
        function printRow(row, drawRowHooks, drawCellHooks) {
            ...
            for (var i = 0; i < table.columns.length; i++) {
                ...
                var CellsOfNullRow = [];
                for (var ii = row.index + 1; ii < table.rows.length; ii++) {
                    var row2 = table.rows[ii];
                    var columnT = table.columns[i];
                    var cellT = row2.cells[columnT.dataKey];
    ...
    /***/ (function (module, exports, __webpack_require__) {
         ...
         * @param inputData
         */
        function createModels(inputHeaders, headersData, inputData,headerStyles,dataStyles) {
            var splitRegex = /\r\n|\r|\n/g;
            var table = config_1.Config.tableInstance();
            var settings = table.settings;
            var theme = config_1.getTheme(settings.theme);
            // Header row and columns
            var headerRow = new models_1.Row(inputHeaders, -1);//add
            headerRow.index = -1;
            ...
            inputHeaders.forEach(function (rawColumn, index) {
                ...
                //table.headerRows.push(headerRow);//add

                //headersData.foreach(function (row, index) {
            ...
            headersData.forEach(function (rawRow, i) {
                ...
                table.columns.forEach(function (column) {
                    ...
                    cell.styles = config_1.Config.styles([theme.table, theme.header, table.styles.styles, table.styles.headerStyles]);
                    cell.styles.valign = headerStyles[i][column.index].valign;
                    cell.styles.halign = headerStyles[i][column.index].halign;
            ...
            inputData.forEach(function (rawRow, i) {
                ...
                table.columns.forEach(function (column) {
                    ...
                    cell.styles.valign = dataStyles[i][column.index].valign;
                    cell.styles.halign = dataStyles[i][column.index].halign;
                    if (cell.raw && cell.raw instanceof HTMLElement) {
                        cell.text = (cell.raw.innerText || '').trim();
                    }
                    else {
    ...
    /***/ (function (module, exports, __webpack_require__) {
         ...
         */
        jsPDF.API.autoTable = function (headers, dataHeaders, data,headerStyles,dataStyles, tableOptions) {
            ...
            creator_1.createModels(headers, dataHeaders, data,headerStyles,dataStyles);
            ...
            if (settings.showHeader === true || settings.showHeader === 'firstPage' || settings.showHeader === 'everyPage') {
                //painter_1.printRow(table.headerRow, table.hooks.drawHeaderRow, table.hooks.drawHeaderCell);
                //table.headerRows.forEach(function (row) {
                for (var i = 0; i < table.headerRows.length; i++) {
                    painter_1.printHeaderRow(table.rows[i], table.hooks.drawHeaderRow, table.hooks.drawHeaderCell);
            ...
            for (var i = table.headerRows.length; i < table.rows.length; i++) {

                painter_1.printFullRow(table.rows[i], table.hooks.drawRow, table.hooks.drawCell);
            }
            //});
