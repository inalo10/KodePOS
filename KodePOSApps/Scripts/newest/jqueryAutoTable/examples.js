...
examples.spans = function (a,b,c,d) {
    ...
    var data = getData2(80);
    var headerData = getColumns2();
    var styleofCells = getCellsStyle2();
    colLength = data.length;
    data.sort(function (a, b) {
        return parseFloat(b.expenses) - parseFloat(a.expenses);
    });
    doc.autoTable(headerKeys(),headerData, data, {
        theme: 'grid',
        startY: 60,
...
var getCellsStyle2 = function(){
    ...
    data.forEach(function(row,index){
        ...
        var tt = row;
        headerKeys.forEach(function(col,index){
            var tt
        });
...
var getColumns2 = function(){
    var da = [];
    da["uraian"] = ["Uraian",null];
    da["tahuntanam"] = ["Tahun Tanam",null];
    da["afdelingIha"] = ["Afdeling I","Ha"];
    da["afdelingIpkk"] = [null,"Pokok"];
    da["afdelingpkkperha"] = [null,"Pokok / Ha"];
    ...
    for (var j = 0; j <= 1; j++) {
        data.push({
            uraian: da.uraian[j],
            tahuntanam: da.tahuntanam[j],
            afdelingIha: da.afdelingIha[j],
            afdelingIpkk: da.afdelingIpkk[j],
            afdelingpkkperha: da.afdelingpkkperha[j],
...
var headerKeys = function () {
    return [
        {title: "Uraian", dataKey: "uraian"},
        {title: "TahunTanam", dataKey: "tahuntanam"},
        {title: "Afdeling I\nHa", dataKey: "afdelingIha"},
        {title: "Afdeling I\nPokok", dataKey: "afdelingIpkk"},
        {title: "Afdeling I\nPokok/Ha", dataKey: "afdelingpkkperha"}
    ];
};

// Uses the faker.js library to get random data.

function getData2(rowCount) {
    rowCount = rowCount || 4;
    var da = [];
    da["uraian"] = ["A. Tanaman Menghasilkan","TM",null,"Sub Total","B. Tanaman Belum Menghasilkan","TBM",null];
    da["tahuntanam"] = [null,"1990","1991",null,null,"1992","1993"];
    da["afdelingIha"] = [null,"90","80","170",null,"101","100"];
    da["afdelingIpkk"] = [null,"90","80","170",null,"101","100"];
    da["afdelingpkkperha"] = [null,"1","1","1",null,"1","1"];
